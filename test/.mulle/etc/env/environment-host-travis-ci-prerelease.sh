...
#
# mulle-mmap url: ${MULLE_MMAP_URL:-https://github.com/mulle-objc-ports/mulle-mmap/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_MMAP_URL="https://github.com/mulle-objc-ports/mulle-mmap.git"
